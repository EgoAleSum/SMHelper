...
describe('SMHelper.js', () => {
    ...
    it('buildQuerystring should return correctly formed query string', () => {
        ...
        SMHelper.buildQuerystring({array1: [1, 100, 0], array2: [0]}).should.be.equal('array1[]=1&array1[]=100&array1[]=0&array2=0')
        SMHelper.buildQuerystring({empty: ['']}).should.be.equal('empty')
        SMHelper.buildQuerystring({empty: [0, '']}).should.be.equal('empty[]=0&empty[]')
    ...
    it('cloneObject should clone an object', () => {
        const startingObject = {a: 1, b: {x: 2, y: [3, 4]}, c: 'hello world!'}
        const clone = SMHelper.cloneObject(startingObject)
    ...
    it('getDescendantProperty should return the correct nested property from an object', () => {
        const t = SMHelper.getDescendantProperty

        const obj = {a: 1, b: {x1: 10, x2: 20, x3: {y1: 15, y2: 'Hello'}}, c: {x1: Infinity, x2: null, x3: false}, d: [100, 200, 300]}
    ...
    it('isPlainObject should identify plain objects', () => {
        const t = SMHelper.isPlainObject
